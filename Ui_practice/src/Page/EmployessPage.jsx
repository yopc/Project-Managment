...
//             <Profile imageSrc={employee?.profilePicture} styleProp={'w-8 h-8'}/>
//             <h1>{employee?.fullName}</h1>
//             <h1>{employee?.email}</h1>
//             <h1>{employee?.Directorate}</h1>
//             <h1>{employee?.JobTitle}</h1>
//             <h1>{employee?.role}</h1>
//             <h1>{employee?.phoneNumber}</h1>
//             <h1>where is bio</h1>
//             <h1>{employee?.bio}</h1>
//            {(employee?.SupplementaryFile ?? []).map((supfile, index) => (
        
    

//   <a
//     key={index}
//     className="bg-green-200 block text-blue-600 underline cursor-pointer"
//     href={supfile.data}
//     download={supfile.fileName}
//   >
//     {supfile.fileName}
